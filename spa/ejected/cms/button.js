...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ("commitList" in $$props) $$invalidate(3, commitList = $$props.commitList);
	...
	return [buttonText, status, onSubmit, commitList, action, encoding];
}
