...
// (47:8) {#if field.constructor === [].constructor}
...
// (76:4) {#if results && results.length > 0}
			...
			filteredContent.forEach(content => {
				option.search.forEach(field => {
					if (content.fields.hasOwnProperty(field) && content.fields[field].includes(input)) {
						$$invalidate(2, results = [...results, content[option.result]]);
					}
				});
			});
		});
