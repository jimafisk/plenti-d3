...
function instance($$self, $$props, $$invalidate) {
	...
	const handle404 = () => {
		...
		import("../layouts/content/404.js").then(component => {
			$$invalidate(3, layout = component.default);
		}).catch(err => {
 ...
 */
	...
	allContent.forEach(currentContent => {
		router.on(env.baseurl + currentContent.path, () => {
			...
			import("../layouts/content/" + currentContent.type + ".js").then(component => {
				$$invalidate(2, content = currentContent);
				$$invalidate(3, layout = component.default);
			}).catch(handle404);
		});
	});
