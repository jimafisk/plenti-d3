		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(div5, "click", /*toggleMediaModal*/ ctx[13])
				];
...
function create_else_block_1(ctx) {
	...
	function fileupload_media_binding(value) {
		/*fileupload_media_binding*/ ctx[26](value);
	}

	function fileupload_changingMedia_binding(value) {
		/*fileupload_changingMedia_binding*/ ctx[27](value);
	}

	function fileupload_showMediaModal_binding(value) {
		/*fileupload_showMediaModal_binding*/ ctx[28](value);
	}
	...
	let fileupload_props = { mediaPrefix: /*mediaPrefix*/ ctx[12] };

	if (/*media*/ ctx[3] !== void 0) {
		fileupload_props.media = /*media*/ ctx[3];
	}

	if (/*changingMedia*/ ctx[9] !== void 0) {
		fileupload_props.changingMedia = /*changingMedia*/ ctx[9];
	}

	if (/*showMediaModal*/ ctx[4] !== void 0) {
		fileupload_props.showMediaModal = /*showMediaModal*/ ctx[4];
	}
	...
	binding_callbacks.push(() => bind(fileupload, "media", fileupload_media_binding));
	binding_callbacks.push(() => bind(fileupload, "changingMedia", fileupload_changingMedia_binding));
	binding_callbacks.push(() => bind(fileupload, "showMediaModal", fileupload_showMediaModal_binding));
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (!updating_media && dirty[0] & /*media*/ 8) {
				updating_media = true;
				fileupload_changes.media = /*media*/ ctx[3];
				add_flush_callback(() => updating_media = false);
			}

			if (!updating_changingMedia && dirty[0] & /*changingMedia*/ 512) {
				updating_changingMedia = true;
				fileupload_changes.changingMedia = /*changingMedia*/ ctx[9];
				add_flush_callback(() => updating_changingMedia = false);
			}

			if (!updating_showMediaModal && dirty[0] & /*showMediaModal*/ 16) {
				updating_showMediaModal = true;
				fileupload_changes.showMediaModal = /*showMediaModal*/ ctx[4];
...
function create_if_block_4(ctx) {
	...
	function mediabrowser_media_binding(value) {
		/*mediabrowser_media_binding*/ ctx[23](value);
	}

	function mediabrowser_changingMedia_binding(value) {
		/*mediabrowser_changingMedia_binding*/ ctx[24](value);
	}

	function mediabrowser_showMediaModal_binding(value) {
		/*mediabrowser_showMediaModal_binding*/ ctx[25](value);
	}

	let mediabrowser_props = {};

	if (/*media*/ ctx[3] !== void 0) {
		mediabrowser_props.media = /*media*/ ctx[3];
	}

	if (/*changingMedia*/ ctx[9] !== void 0) {
		mediabrowser_props.changingMedia = /*changingMedia*/ ctx[9];
	}

	if (/*showMediaModal*/ ctx[4] !== void 0) {
		mediabrowser_props.showMediaModal = /*showMediaModal*/ ctx[4];
	}

	mediabrowser = new MediaBrowser({ props: mediabrowser_props });
	binding_callbacks.push(() => bind(mediabrowser, "media", mediabrowser_media_binding));
	binding_callbacks.push(() => bind(mediabrowser, "changingMedia", mediabrowser_changingMedia_binding));
	binding_callbacks.push(() => bind(mediabrowser, "showMediaModal", mediabrowser_showMediaModal_binding));
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (!updating_media && dirty[0] & /*media*/ 8) {
				updating_media = true;
				mediabrowser_changes.media = /*media*/ ctx[3];
				add_flush_callback(() => updating_media = false);
			}

			if (!updating_changingMedia && dirty[0] & /*changingMedia*/ 512) {
				updating_changingMedia = true;
				mediabrowser_changes.changingMedia = /*changingMedia*/ ctx[9];
				add_flush_callback(() => updating_changingMedia = false);
			}

			if (!updating_showMediaModal && dirty[0] & /*showMediaModal*/ 16) {
				updating_showMediaModal = true;
				mediabrowser_changes.showMediaModal = /*showMediaModal*/ ctx[4];
				add_flush_callback(() => updating_showMediaModal = false);
			}
...
function create_else_block(ctx) {
	...
	function visualeditor_showMediaModal_binding(value) {
		/*visualeditor_showMediaModal_binding*/ ctx[37](value);
	}

	function visualeditor_changingMedia_binding(value) {
		/*visualeditor_changingMedia_binding*/ ctx[38](value);
	}
	...
	if (/*showMediaModal*/ ctx[4] !== void 0) {
		visualeditor_props.showMediaModal = /*showMediaModal*/ ctx[4];
	}

	if (/*changingMedia*/ ctx[9] !== void 0) {
		visualeditor_props.changingMedia = /*changingMedia*/ ctx[9];
	}
	...
	binding_callbacks.push(() => bind(visualeditor, "showMediaModal", visualeditor_showMediaModal_binding));
	binding_callbacks.push(() => bind(visualeditor, "changingMedia", visualeditor_changingMedia_binding));
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (!updating_showMediaModal && dirty[0] & /*showMediaModal*/ 16) {
				updating_showMediaModal = true;
				visualeditor_changes.showMediaModal = /*showMediaModal*/ ctx[4];
				add_flush_callback(() => updating_showMediaModal = false);
			}

			if (!updating_changingMedia && dirty[0] & /*changingMedia*/ 512) {
				updating_changingMedia = true;
				visualeditor_changes.changingMedia = /*changingMedia*/ ctx[9];
				add_flush_callback(() => updating_changingMedia = false);
			}
...
function create_fragment(ctx) {
	...
	let if_block1 = /*showMediaModal*/ ctx[4] && create_if_block_3(ctx);
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(a3, "click", prevent_default(/*toggleMediaModal*/ ctx[13])),
		...
		p(new_ctx, dirty) {
			...
			if (/*showMediaModal*/ ctx[4]) {
				if (if_block1) {
					if_block1.p(ctx, dirty);

					if (dirty[0] & /*showMediaModal*/ 16) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const toggleMediaModal = () => {
		$$invalidate(4, showMediaModal = !showMediaModal);
		$$invalidate(9, changingMedia = "");
	};
	...
	return [
		...
		click_handler_3,
		click_handler_4,
		mediabrowser_media_binding,
		mediabrowser_changingMedia_binding,
		mediabrowser_showMediaModal_binding,
		fileupload_media_binding,
		fileupload_changingMedia_binding,
		fileupload_showMediaModal_binding,
		...
		visualeditor_showMediaModal_binding,
		visualeditor_changingMedia_binding,
