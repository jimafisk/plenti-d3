...
function instance($$self, $$props, $$invalidate) {
	let { media } = $$props, { changingMedia } = $$props;
	let { filters = [] } = $$props;
	let { enabledFilters = [] } = $$props;
	let { filteredMedia = [] } = $$props;
	...
	$$self.$$set = $$props => {
		...
		if ("changingMedia" in $$props) $$invalidate(8, changingMedia = $$props.changingMedia);
		...
		if ("filteredMedia" in $$props) $$invalidate(6, filteredMedia = $$props.filteredMedia);
		if ("singleSelect" in $$props) $$invalidate(9, singleSelect = $$props.singleSelect);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*media, enabledFilters*/ 129) {
			// Filter media
			$: $$invalidate(6, filteredMedia = media.filter(mediaFile => {
