...
function create_else_block_1(ctx) {
	...
	return {
		...
		h() {
			...
			input.multiple = input_multiple_value = /*changingMedia*/ ctx[2] ? false : true;
		...
		p(ctx, dirty) {
			...
			if (dirty & /*changingMedia*/ 4 && input_multiple_value !== (input_multiple_value = /*changingMedia*/ ctx[2] ? false : true)) {
...
function create_if_block(ctx) {
	...
	function mediafilters_media_binding(value) {
		/*mediafilters_media_binding*/ ctx[16](value);
	}
	...
	let mediafilters_props = {
		singleSelect: true,
		changingMedia: /*changingMedia*/ ctx[2]
	};

	if (/*media*/ ctx[1] !== void 0) {
		mediafilters_props.media = /*media*/ ctx[1];
	}
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*changingMedia*/ 4) mediafilters_changes.changingMedia = /*changingMedia*/ ctx[2];

			if (!updating_media && dirty & /*media*/ 2) {
				updating_media = true;
				mediafilters_changes.media = /*media*/ ctx[1];
			...
			if (dirty & /*$$scope, selectedMedia, localMediaList, enabledFilters, filePrefix, mediaPrefix, changingMedia, showMediaModal*/ 33554813) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const addUploadToLibrary = () => {
		localMediaList.forEach(m => {
			$$invalidate(1, media = [...media, m.contents]);
		});
	};
	...
	const click_handler = () => {
		addUploadToLibrary();
		$$invalidate(5, enabledFilters = []);
		$$invalidate(6, filePrefix = mediaPrefix + "media/");

		if (changingMedia) {
			$$invalidate(2, changingMedia = localMediaList[0].file);
			$$invalidate(3, showMediaModal = false);
		}
	};
	...
	$$self.$$set = $$props => {
		...
		if ("showMediaModal" in $$props) $$invalidate(3, showMediaModal = $$props.showMediaModal);
		if ("localMediaList" in $$props) $$invalidate(0, localMediaList = $$props.localMediaList);
		if ("mediaPrefix" in $$props) $$invalidate(4, mediaPrefix = $$props.mediaPrefix);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*enabledFilters, mediaPrefix, localMediaList, filePrefix*/ 113) {
			$: if (enabledFilters) {
